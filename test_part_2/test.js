...
// c cannot be accessed here as it is limit to  the scope of function scope()
...
console.log(ConcatenateString("Shreyash","Shinde"))

// 25 Sort An Array
const arr9 = ["Apple", "Banana","Watermelon"];
